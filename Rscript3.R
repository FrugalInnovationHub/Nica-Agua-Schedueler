...
#------------------------------------------------------------------------------------------------------------------
  ...
  FiveDay25 = quantile(df.5Day, prob=c(.15))
  FiveDay75 = quantile(df.5Day, prob=c(.85))
  ...
  TenDay25 = quantile(df.10Day, prob=c(.15))
  TenDay75 = quantile(df.10Day, prob=c(.85))
  ...
  FifteenDay25 = quantile(df.15Day, prob=c(.15))
  FifteenDay75 = quantile(df.15Day, prob=c(.85))
  #------------------------------------------------------------------------------------------------------------------
  #Final Organization
